...
This project aims to build a **remote management platform for real-world robots** using a
WeChat Mini Program.

Core capabilities include:
- Displaying robot operational status and battery information
- Viewing telemetry and fault records
- Issuing remote control commands to robots
...
- Strict frontend–backend decoupling through standardized interfaces

This ensures that **real robot integration can be completed later without refactoring the existing system**.
...
A single cloud function provides all backend APIs, dispatched via the action parameter.
...
All backend APIs execute successfully in uniCloud
